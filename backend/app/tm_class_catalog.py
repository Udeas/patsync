"""Trademark class constraints and standard descriptions."""
...
TM_CLASS_DESCRIPTIONS: Dict[str, str] = {
    ...
    "28": "Games, toys and playthings; video game apparatus; gymnastic and sports equipment; decorations for Christmas trees.",
    ...
    "30": "Coffee, tea, cocoa and artificial coffee; rice, pasta and noodles; tapioca and sago; flour and preparations made from cereals; bread, pastries and confectionery; chocolate; ice cream, sorbets and other edible ices; sugar, honey, treacle; yeast, baking-powder; salt, mustard; vinegar, sauces (condiments); spices; ice.",
    ...
    "99": "Multiple class application. Specify all applicable classes in comments.",
}


def validate_tm_class_value(value: str) -> str:
    normalized = (value or "").strip()
    if normalized not in VALID_TM_CLASS_VALUES:
        raise ValueError("tm_class must be one of 1-45 or 99")
    return normalized


def class_description_for(value: str) -> str | None:
    return TM_CLASS_DESCRIPTIONS.get((value or "").strip())
